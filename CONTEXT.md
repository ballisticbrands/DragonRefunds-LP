# DragonBot landing page
This is the landing page for DragonBot.
...
* * photo generation - a similar sequence
* * PPC automation - a similar sequence
* * acc management - a similar sequence
* How it works section - three steps - "Choose plan" - "We set it up for you and help you connect all your services" - "Start using it"
* Plans section - "$0 demo call" - "~$150~ FREE setup + $39/mo (commitment to 3 months)" (the ~~ denotes strikethrough) - $150~ FREE setup + $99/mo (commitment to 3 months)" - each section will have features listed underneath it, put placeholders for now

## Colors

* 2F7D4F and 98cc65 - primary
* 0F3D2E - serious stuff - like footer background
* white - page background
* D63C3C - highlights
* 1A1A1A - text and other lines

## Fonts

* clash display - titles (also logos)
* satoshi - regular text

## Logos
* use ./dragonbot_fire.png as the logo for DragonBot
* "DragonBot" in "clash display" font should appear to the right of it
