    ...
    <div className="db-page min-h-screen bg-[#0F0F0F] text-white" style={{ fontFamily: sysFont }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center">
          <p className="text-white/70 text-sm mb-2">Still need help?</p>
          ...
          <p className="text-xs text-white/60 mt-6">&copy; {new Date().getFullYear()} Chacha Advisory LLC. All rights reserved.</p>
